...
So far, we used render* functions and reactives to take care of our output. It’s all happening inside the app.
...
You can see them as a backpack 🎒: they carry a value around and you can ask them for it whenever you want.
...
That's similar with a reactive. They can carry and do different things:
...
Want to keep learning? Check out the [ProductioniZing Shiny Course](https://athlyticz.com/shiny-applications) with yours truly as course instructor! 🎉👉🏻 **https://athlyticz.com/shiny-applications**
